    ...
    try {
        ...
        switch (req.body.typeOf) {
            case req.chevre.factory.account.transactionType.Deposit:
                transaction = yield req.chevre.service.accountTransaction.deposit.start(Object.assign({ project: { id: req.body.project.id, typeOf: req.chevre.factory.organizationType.Project }, typeOf: req.chevre.factory.account.transactionType.Deposit, transactionNumber,
                    agent,
                    recipient, object: {
            ...
            case req.chevre.factory.account.transactionType.Transfer:
                transaction = yield req.chevre.service.accountTransaction.transfer.start(Object.assign({ project: { id: req.body.project.id, typeOf: req.chevre.factory.organizationType.Project }, typeOf: req.chevre.factory.account.transactionType.Transfer, transactionNumber,
                    agent,
                    recipient, object: {
                        amount: { value: req.body.object.amount.value },
            ...
            case req.chevre.factory.account.transactionType.Withdraw:
                transaction = yield req.chevre.service.accountTransaction.withdraw.start(Object.assign({ project: { id: req.body.project.id, typeOf: req.chevre.factory.organizationType.Project }, typeOf: req.chevre.factory.account.transactionType.Withdraw, transactionNumber,
                    agent,
                    recipient, object: {
                        amount: { value: req.body.object.amount.value },
                        fromLocation: { accountNumber: req.body.object.fromLocation.accountNumber },
...
accountTransactionsRouter.put('/:transactionNumber/confirm', (0, permitScopes_1.permitScopes)(['admin']), validator_1.validator, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const accountRepo = new req.chevre.repository.Account(mongoose.connection);
        const transactionRepo = new req.chevre.repository.AccountTransaction(mongoose.connection);
        const accountTransaction = yield req.chevre.service.accountTransaction.confirm({
        ...
        yield req.chevre.service.account.transferMoney(moneyTransferActionAttributes)({
            account: accountRepo
        });
...
accountTransactionsRouter.put('/:transactionNumber/cancel', (0, permitScopes_1.permitScopes)(['admin']), validator_1.validator, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield req.chevre.service.account.cancelMoneyTransfer({
            transaction: {
